...
const Skills = () => {
  return (
    <div name='skills' className='w-full h-screen bg-[#d4e0f2] text-cyan-950'>
      {/* Container */}
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
          <div className=' w-full flex justify-center items-center flex-col mb-7'>
              <p className='text-4xl font-bold inline border-b-4 border-blue-600 text-center '>Skills</p>
